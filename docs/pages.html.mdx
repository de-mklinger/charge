...
A default layout component can be placed in the file `layout.html.jsx` as the default export. This file will be used for all MDX pages in this directory that don't export a `layout`.
