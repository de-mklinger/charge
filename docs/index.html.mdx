import Logotype from "./components/logotype.html.jsx"
...
<div className="container" style={{ textAlign: "center" }}>
  <Logotype as="h1" style={{ fontSize: "3rem" }} />
</div>

<div style={{ height: "2rem" }} />

![tests](https://img.shields.io/github/workflow/status/brandonweiss/charge/Tests?label=tests&logo=github)
![npm](https://img.shields.io/npm/v/@static/charge?logo=NPM)
![node](https://img.shields.io/node/v/@static/charge?logo=Node.js)
![documentation](https://img.shields.io/badge/documentation-lit-blueviolet)
...
Charge can be used for blogging, but it’s not a tool specifically _for_ blogging, if that makes sense.
...
If you’d like to see what a simple blog with Charge might look like, here’s an [example of a switch from Middleman to Charge][blog-switch].
...
[blog-switch]: https://github.com/brandonweiss/anti-pattern/commit/bf3e91ebb8211a7b22183e165ce8cc287b40b729
